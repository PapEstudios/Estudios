...
int main() {
    ...
    scanf("%f",& nt3);  //list
     ...
     float t1=ntt1*0.30;
     printf("La nota del primer timestre es: %3.2f", t1);
     //here begin the notes of the 2nd quarter
      printf("\n ingresa 1er nota  del 2do trimestre:");    //list
    scanf("%f",& mt1);  //list
    ...
    scanf("%f",& mt3);  //list
     ...
     float t2=ntt2*0.30;
     printf("La nota del primer timestre es: %3.2f", t2);
     //here begin the notes of the 3th quarter
      printf("\n ingresa 1er nota  del 3er trimestre:");    //list
    scanf("%f",& ct1);  //list
    ...
    scanf("%f",& ct3);  //list
     ...
     float t3=ntt3*0.30;
     printf("\n La nota del primer timestre es: %3.2f", t3);
