...
fn main(){
    ...
    let promedio = t1+t2+t3;
    println!("El promedio es {promedio}");
    if promedio >= 14.0 {
        println!("El estudiante {nombre} del curso {curso}{paralelo} paso de año con una nota de {promedio} ");
    }else{
        println!("El estudiante {nombre} del curso {curso} paralelo {paralelo} se queda de año con una nota de {promedio} ");
    }
}